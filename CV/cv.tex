...
\begin{rSection}{Publications} \itemsep 4pt
    ...
    \begin{rSubsection}{INTERNATIONAL CONFERENCES (REFEREED)}{}{}{}{}
        \item \textbf{Naoya Muramatsu*}, Zico da Silva*, Daniel Joska, Fred Nicolls, Amir Patel. 2022. Improving 3D Pose Estimation of Cheetahs in the Wild. In \textit{International Conference on Robotics and Automation} (ICRA 2022). IEEE, Philadelphia (PA), USA. (* Joint first authorship) (Submitted for Initial Review)
